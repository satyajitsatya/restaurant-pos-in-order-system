        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Update product details and information</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">Fill in the details below to update the product</p>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" rows="4" 
                                          ...
                                          placeholder="Describe the product in detail...">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="mt-2 flex items-center text-sm text-red-600">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" id="price" step="0.01" min="0" value="{{ old('price', $product->price) }}" required
                                           class="price-input form-input w-full border-2 border-gray-200 rounded-lg pl-8 pr-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 @error('price') border-red-300 focus:ring-red-500 @enderror" 
                                           placeholder="0.00">
                                </div>
                                @error('price')
                                    <div class="mt-2 flex items-center text-sm text-red-600">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-200 rounded-lg flex items-center justify-center">
                                        <span class="text-white font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200">Current Product Image</span>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    ...
                                    Leave empty to keep current image. Recommended size: 400x300 pixels
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <select name="spice_level" id="spice_level" required 
                                        ...
                                        <option value="mild" {{ old('spice_level', $product->spice_level) == 'mild' ? 'selected' : '' }}>🌶️ Mild - No heat</option>
                                        <option value="medium" {{ old('spice_level', $product->spice_level) == 'medium' ? 'selected' : '' }}>🌶️🌶️ Medium - Moderate heat</option>
                                        <option value="hot" {{ old('spice_level', $product->spice_level) == 'hot' ? 'selected' : '' }}>🌶️🌶️🌶️ Hot - Very spicy</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-sm text-gray-500">Enable or disable this product</p>
                                        </div>
                                    </div>
